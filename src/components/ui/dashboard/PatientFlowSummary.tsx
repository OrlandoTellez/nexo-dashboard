...
export const PatientFlowSummary = ({ waiting, inConsultation, attended, critical }: Props) => (
  <div className="bg-gradient-card bg-white rounded-xl border shadow-sm">
    <div className="p-4 border-b bg-[#007DE4] rounded-t-lg text-white">
    ...
    <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="text-center p-4 bg-[#99C81899] rounded-lg">
      ...
      <div className="text-center p-4 bg-[#F9D7D6] rounded-lg">
